...
public class ECommerceApplication {
	...
	public static void main(String[] args) {
		...
		// televisions
		Product p6 = new Product("Old TV", 22.99, 1, "This is a old television from 2003, we need to make money so we are still selling it but at a fair price.", "https://www.junkoutinc.com/wp-content/uploads/2020/04/donating-tv-charity.jpg", "OnSale", "Television");
		session.save(p6);
		...
		session.save(p16);
		// Phone accessories
		Product p17 = new Product("TripGrip Window & Vent Mount for Most Cell Phones", 19.99, 8, " Bracketron's TripGrip is two mounts in one. Mount your phone on your windshield or on an air vent.","https://www.quill.com/is/image/Quill/sp30225024_s7?iv=RLYpN3&wid=1080&hei=1080&fit=fit,1","On Sale", "Phone Accessories");
		session.save(p17);
