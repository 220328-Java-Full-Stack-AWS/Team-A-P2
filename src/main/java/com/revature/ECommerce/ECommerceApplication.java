...
//		tx.commit();
		...
		//The space below is used to test product repos
		...
		Product item1 = new Product("Dress Pants",99.00, 100, "Some nice dress pants", "imgurl", "In Stock", "Clothes");
		Product item2 = new Product("White T-Shirt",10.00, 100, "Plain white t-shirt", "imgurl", "In Stock", "Clothes");
		Product item3 = new Product("Cowboy Hat",95.00, 0, "YEE-HAW Hat", "imgurl", "Out of Stock", "Clothes");
		session.save(item1);
		session.save(item2);
		session.save(item3);
