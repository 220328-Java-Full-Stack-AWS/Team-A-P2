...
//    @Test
//    void save() {
//        Address address1 = new Address("testAddy1","testCity","testState",1,"testCountry");
//        Address address2 = new Address("testAddy2","testCity","testState",1,"testCountry");
//
...
//    @Test
//    void getAddressById() {
//        Address testAddy = new Address("testAddress","testCity","testState",1,"testCountry");
...
//        addressList.add(address2);
//
//        Mockito.doNothing().when(mockAddyRepo).delete(any(Address.class));
//        aServ.deleteAddress(address1);
//
//        Mockito.verify(mockAddyRepo).delete(address1);
//    }
//
//    @Test
//    void getByState() {
...
//    @Test
//    void getByCity() {
//        Address address1 = new Address("testAddy","testCity","testState",1,"testCountry");
//        Address address2 = new Address("testAddy2","testCity","testState",1,"testCountry");
//        address1.setAddressId(1);
//        address2.setAddressId(2);
//        List<Address> addressList = new ArrayList<>();
...
//        Address address = new Address("testAddy","testCity","testState",1,"testCountry");
